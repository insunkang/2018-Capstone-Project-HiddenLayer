...
public class ShowNowMoldActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_now_mold);

        nowMoldListView = findViewById(R.id.nowMoldListView);

        mArrayList = new ArrayList<>();
        GetData getData = new GetData();
        getData.execute("http://smurf1213.cafe24.com/select_now_mold.php");
    ...
    private class GetData extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(ShowNowMoldActivity.this,
    ...
    private void showResult() {
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ShowNowMoldActivity.this, mArrayList, R.layout.list_item_need_to_change_mold,
            ...
            nowMoldListView.setAdapter(adapter);
